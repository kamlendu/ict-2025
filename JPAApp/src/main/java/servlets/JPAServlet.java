...
public class JPAServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           // dbl.addBook("The Midnight Children", "Salman Rushdie", "Rupa pub", "A fantacy Novel");
            
           // dbl.updateBook(361,"The Midnight Children", "Salman Rushdie", "India Pub", "A fantacy Novel");
           ...
           dbl.removeBook(361);
            ...
            for(BookMaster b : books)
            {
                ...
                out.println("<h2>Book Name : " + b.getBookName()+ "   Author Name "+ b.getAuthorName()+"</h2>");
